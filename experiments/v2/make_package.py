...
OUT  = pathlib.Path("/root/imtoiteu/quantum-error-mitigation-submission-package.zip")
...
RAW_CANDIDATES = ["results/v2/raw/main_study.jsonl", "results/v2/raw/pilot.jsonl",
